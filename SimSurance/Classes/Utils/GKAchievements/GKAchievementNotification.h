...
#define kGKAchievementDefaultSize   CGRectMake(0.0f, 0.0f, 500.0f, 52.0f);
...
#define kGKAchievementText1         CGRectMake(10.0, 6.0f, 465.0f, 22.0f);
#define kGKAchievementText2         CGRectMake(10.0, 20.0f, 465.0f, 22.0f);
#define kGKAchievementText1WLogo    CGRectMake(45.0, 6.0f, 400.0f, 22.0f);
#define kGKAchievementText2WLogo    CGRectMake(45.0, 20.0f, 400.0f, 22.0f);
